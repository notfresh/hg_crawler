...
class HgSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'ITEM_PIPELINES': {
            ...
            'csdn.pipelines.CsdnWriteJsonPipeline': 100,
        },
        'DOWNLOAD_DELAY': 0.2,
        'LOG_ENABLED': True,
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.text_save_dir = '/Users/zxzx/Documents/csdn_blogs/{}'.format('hellogithub')
        self.json_save_file = '/Users/zxzx/Documents/csdn_blogs/{}.jl'.format('hellogithub')
    ...
    def parse(self, response):
        ...
        for post in posts:
            ...
            read_num = post.xpath('.//span[@class="read-num"]/text()').extract_first()
            item = {
                'url': url,
                'type': type,
                'title': title,
